...
# Updated: 2025-01-06
# Models: gpt-5.3-codex (high), gemini-3.1-pro-preview
...
# Using strongest models: gpt-5.3-codex + gemini-3.1-pro-preview
...
echo "   gr <file>   - Code review (gemini-3.1-pro-preview)"
...
echo "   arch <file> - Architecture review (gemini-3.1-pro-preview)"
echo ""
