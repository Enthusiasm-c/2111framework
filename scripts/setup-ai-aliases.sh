...
# Updated: 2025-01-06
# Models: gpt-5.1-codex-max (high), gemini-3-pro
...
# Using strongest models: gpt-5.1-codex-max + gemini-3-pro

# Codex (OpenAI) - gpt-5.1-codex-max with high reasoning
...
# Quick bug finder (Codex gpt-5.1-codex-max)
...
# Security audit (Codex gpt-5.1-codex-max)
...
# Performance review (Codex gpt-5.1-codex-max)
...
# Architecture review (Gemini 3 Pro - good for high-level)
...
echo "   cr <file>   - Code review (gpt-5.1-codex-max, high reasoning)"
echo "   gr <file>   - Code review (gemini-3-pro)"
echo "   bug <file>  - Bug finder (gpt-5.1-codex-max)"
echo "   sec <file>  - Security audit (gpt-5.1-codex-max)"
echo "   perf <file> - Performance review (gpt-5.1-codex-max)"
echo "   arch <file> - Architecture review (gemini-3-pro)"
echo ""
