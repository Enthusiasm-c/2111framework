...
Runs on Claude Opus 5 (`model: opus`; the main session is Claude Fable 5): 1M context, adaptive thinking. Pull the whole feature surface + test files + recent git diff into one pass before writing the test plan.
